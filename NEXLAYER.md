...
**Live:** [https://relaxed-weasel-kafka.cloud.nexlayer.ai](https://relaxed-weasel-kafka.cloud.nexlayer.ai)  
...
**kafka** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
  - name: app
    image: mirror.gcr.io/provectuslabs/kafka-ui:latest
    path: /
    servicePorts:
    - 8080
    vars:
